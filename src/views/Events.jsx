        ...
        <main className="min-h-screen bg-gray-50 py-12 px-4 text-left">
            <div className="max-w-4xl mx-auto">
                <header className="mb-12 text-center animate-fadeIn">
                    <h1 className="text-3xl lg:text-5xl font-black text-indigo-950 uppercase tracking-tighter mb-4">Upcoming Events</h1>
                ...
                <section className="bg-white rounded-3xl shadow-xl overflow-hidden border border-gray-100 animate-fadeInUp">
                    <div className="bg-indigo-900 p-6 flex justify-between items-center text-white">
                        <span className="text-xs font-black uppercase tracking-widest text-indigo-200">Campus Events Tracker</span>
                        ...
                        {events.length > 0 ? (
                            events.map((item, index) => (
                                <a
                                    ...
                                    className="flex items-center gap-6 p-6 sm:p-8 hover:bg-indigo-50/50 transition-all group"
                                >
                                    ...
                                    <div>
                                        ...
                                        <span className="text-[10px] font-black text-indigo-500 uppercase tracking-widest mt-2 block opacity-60">Event Details & Registration</span>
                                    </div>
