        ...
        <div className="min-h-screen flex flex-col bg-gray-50 text-left">
            ...
            <main className="max-w-7xl mx-auto py-8 lg:py-12 px-4 space-y-12">
                ...
                <div id="reAdmission" ref={sectionRefs.reAdmission} className="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-lg transition-all">
                    ...
                    <div className="p-8">
                        <div className="bg-blue-50/50 rounded-2xl p-6 border border-blue-100 text-indigo-900 font-bold text-base lg:text-lg leading-relaxed italic whitespace-pre-line">
                ...
                <div id="scholarships" ref={sectionRefs.scholarships} className="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-lg transition-all">
                    ...
                    <div className="p-8">
                        <div className="mb-6 p-4 bg-indigo-50 rounded-xl border-l-4 border-indigo-600">
                            <p className="text-lg lg:text-xl font-bold text-indigo-900">{content?.Scholarship?.description || 'Scholarship information will be updated soon.'}</p>
                        </div>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            {(Array.isArray(content?.Scholarship?.['list of scholarships']) ? content.Scholarship['list of scholarships'] : []).map((scholarship, index) => (
                                <div key={index} className="flex items-center gap-3 p-4 bg-white border border-gray-200 rounded-xl hover:border-indigo-300 transition-colors">
                                    <span className="bg-indigo-100 text-indigo-700 w-8 h-8 rounded-full flex items-center justify-center font-bold">★</span>
                ...
                <div id="fees" ref={sectionRefs.fees} className="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-lg transition-all">
                    ...
                    <div className="p-8">
                        <a
                            ...
                            className="inline-flex items-center gap-2 px-8 py-4 bg-indigo-600 text-white font-bold rounded-2xl hover:bg-indigo-700 transition-all shadow-md group"
                        >
                            ...
                            {(Array.isArray(content?.['Office bearers']?.['Administration staff']) ? content['Office bearers']['Administration staff'] : []).map((staff, index) => (
                                ...
                                >
                                    <div className="relative mb-4">
                                        ...
                                        />
                                        <div className="absolute -bottom-2 -right-2 bg-indigo-600 text-white p-1 rounded-lg text-xs font-bold shadow-sm">
                                            {staff['S.No']}
                                        </div>
                                    </div>
                                    <h3 className="font-bold text-lg text-indigo-900 uppercase tracking-tight">{staff['Name of the Staff']}</h3>
                                    <div className="h-0.5 w-12 bg-indigo-200 my-2"></div>
                ...
                <div id="contact" ref={sectionRefs.contact} className="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-lg transition-all text-center">
                    <div className="bg-gradient-to-r from-indigo-700 to-blue-600 py-6 px-8 text-white">
                        <h2 className="text-xl lg:text-2xl font-bold">Contact Us</h2>
                    </div>
                    <div className="p-8">
                        <div className="max-w-2xl mx-auto bg-indigo-50/50 p-8 rounded-3xl border border-indigo-100 shadow-inner">
                            <p className="text-lg lg:text-xl font-bold text-indigo-900 whitespace-pre-line leading-loose">
