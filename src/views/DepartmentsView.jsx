                ...
                >
                    ...
                    <div className="container mx-auto h-full flex items-center relative z-10 px-3 sm:px-4 md:px-6 lg:px-9">
                        <div className="max-w-2xl">
                            ...
                            <button className="bg-indigo-600 hover:bg-indigo-700 text-white py-2 px-4 sm:px-6 rounded-full transition duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1">
                                Learn More
                            </button>
                        </div>
                    </div>
                    ...
                    <div id="content-sections" className="w-full">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 items-start">
                                    <div className="flex flex-col h-full">
                                        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden transition-all duration-300 hover:shadow-xl h-full">
                                            <div className="bg-gradient-to-r from-indigo-600 to-blue-500 py-4 sm:py-5 md:py-6">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-1 gap-6 sm:gap-8 h-full">
                                        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden transition-all duration-300 hover:shadow-xl">
                                            <div className="bg-gradient-to-r from-blue-500 to-cyan-400 py-4 sm:py-5 md:py-6">
                        ...
                        <div id="courses-offered" className="px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto py-12 bg-white">
                            <h2 className="text-3xl md:text-4xl font-bold text-center mb-10 text-gray-800">
                                <span className="bg-gradient-to-r from-indigo-600 to-blue-500 bg-clip-text text-transparent">Courses Offered</span>
                            </h2>
                            <div className="max-w-6xl mx-auto">
                                <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden transition-all duration-300 hover:shadow-xl">
                                    <div className="bg-gradient-to-r from-indigo-600 to-blue-500 py-6 sm:py-7 md:py-8">
                                    ...
                                    <div className="p-8 md:p-10">
                                        <div className={`grid gap-4 sm:gap-6 ${(department?.courses_offered?.length || 0) > 1 ? 'grid-cols-1 md:grid-cols-2' : 'justify-center'}`}>
                                            {(department?.courses_offered || []).map((course, index) => (
                                                <div key={index} className="bg-gradient-to-r from-blue-50 to-indigo-50 p-4 sm:p-5 md:p-6 rounded-xl border border-blue-200 hover:border-blue-300 transition-all duration-300 hover:shadow-md">
                                                    <div className="flex items-start space-x-2 sm:space-x-3">
                                                        <div className="flex-shrink-0 w-6 h-6 sm:w-8 sm:h-8 bg-gradient-to-r from-blue-500 to-indigo-500 rounded-full flex items-center justify-center">
                        ...
                        <div id="events" className="px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto py-12 bg-white">
                            <h2 className="text-3xl md:text-4xl font-bold text-center mb-10 text-gray-800">
                                <span className="bg-gradient-to-r from-indigo-600 to-blue-500 bg-clip-text text-transparent">Upcoming Events</span>
                            </h2>
                            {currentEvent ? (
                                <div className="max-w-6xl mx-auto">
                                            ...
                                            <div className="flex flex-col md:flex-row md:items-center justify-between">
                                                <div className="flex-grow mb-4 md:mb-0 md:mr-8 text-left">
                                                    ...
                                                    <div className="flex items-center">
                                                        <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 sm:h-5 sm:w-5 text-indigo-500 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                                                        </svg>
                                                        <span className="text-sm lg:text-base text-indigo-600 font-medium">{currentEvent.date}</span>
                                                    </div>
                                                </div>
                                                <div className="flex justify-center space-x-2 sm:space-x-3">
                                                    <button onClick={showPreviousEvent} className="p-2 rounded-full bg-gray-100 hover:bg-indigo-100 text-gray-600 hover:text-indigo-600 focus:outline-none transition-colors duration-300">
                                                    ...
                                                    <button onClick={showNextEvent} className="p-2 rounded-full bg-gray-100 hover:bg-indigo-100 text-gray-600 hover:text-indigo-600 focus:outline-none transition-colors duration-300">
                                    ...
                                    <div className="flex justify-center mt-4 sm:mt-6 space-x-2">
                                        {events.map((_, index) => (
                                            <div key={index} onClick={() => setCurrentIndex(index)}
                                                className={`w-2 h-2 rounded-full cursor-pointer transition-colors duration-300 ${index === currentIndex ? 'bg-indigo-600' : 'bg-gray-300 hover:bg-gray-400'}`}>
                                            </div>
                                        ))}
                                    </div>
                                </div>
                        ...
                        <div id="achievements" className="px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto py-12 bg-gray-50">
                            <h2 className="text-3xl md:text-4xl font-bold text-center mb-10 text-gray-800">
                                <span className="bg-gradient-to-r from-purple-600 to-indigo-600 bg-clip-text text-transparent">Department Achievements</span>
                            </h2>
                            <div className="max-w-6xl mx-auto">
                                <div className="relative">
                                    <div className="absolute top-0 bottom-0 left-0 right-0 -m-2 sm:-m-4 bg-gradient-to-r from-purple-50 to-indigo-50 rounded-3xl transform -rotate-1"></div>
                                                        ...
                                                        <div className="flex flex-col md:flex-row md:items-center justify-between">
                                                            <div>
                                                                <div className="flex items-center mb-2">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 sm:h-5 sm:w-5 text-indigo-500 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                                                            ...
                                                            <div className="mt-3 md:mt-0 bg-indigo-50 text-indigo-700 px-2 sm:px-3 py-1 rounded-full text-xs lg:text-sm font-medium h-fit">
                                                                {achievement.date}
                                                            </div>
                                                        </div>
                                                        <div className="mt-3">
                        ...
                        <div id="faculty" className="px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto py-12 bg-gray-50">
                            <div className="text-center mb-8 sm:mb-10 lg:mb-12">
                                <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-800 relative inline-block group">
                                    OUR FACULTY
                                    <span className="absolute -bottom-2 sm:-bottom-3 left-0 h-1 w-full bg-gradient-to-r from-blue-600 to-indigo-600 transform origin-left transition-transform duration-300 group-hover:scale-x-110"></span>
                                </h2>
                            </div>
                            {/* HOD Desk */}
                            <div className="mb-12 sm:mb-14 lg:mb-16">
                                <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-center mb-6 sm:mb-8 text-transparent bg-clip-text bg-gradient-to-r from-blue-700 to-indigo-700">Head of Department</h3>
                                <div className="flex justify-center">
                                    {(Array.isArray(department?.faculty?.hod_desk) ? department.faculty.hod_desk : []).map((staff, i) => (
                                        <div key={i} className="bg-white rounded-xl shadow-lg overflow-hidden border border-blue-100 transform transition-all duration-300 cursor-pointer min-h-[380px] max-w-[320px] w-80 flex-shrink-0 flex-grow-0 hover:-translate-y-3 hover:scale-[1.03] hover:shadow-2xl hover:border-blue-600" onClick={() => showDetails(staff)}>
                                            ...
                                            <div className="p-6 text-center">
                                                <h4 className="text-lg font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600 mb-2">{staff.name}</h4>
                                                <p className="text-gray-700 font-medium">{staff.position}</p>
                                                <p className="text-gray-500 text-sm">{staff.email}</p>
                                                <button className="mt-4 px-4 py-2 bg-gradient-to-r from-blue-600 to-indigo-600 text-white text-sm rounded-lg hover:from-blue-700 hover:to-indigo-700 transition-all font-semibold">View Profile</button>
                                            </div>
                                        </div>
                                    ))}
                                </div>
                            ...
                            <div>
                                <h3 className="text-2xl font-bold text-center mb-8 text-transparent bg-clip-text bg-gradient-to-r from-blue-700 to-indigo-700">Professors</h3>
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 justify-items-center">
                                    {(Array.isArray(department?.faculty?.assistant_professors) ? department.faculty.assistant_professors : []).map((staff, i) => (
                                        <div key={i} className="bg-white rounded-xl shadow-lg overflow-hidden border border-blue-100 transform transition-all duration-300 cursor-pointer min-h-[380px] max-w-[320px] w-80 flex-shrink-0 flex-grow-0 hover:-translate-y-2 hover:scale-[1.02] hover:shadow-2xl hover:border-blue-600" onClick={() => showDetails(staff)}>
                                            <div className="relative pt-2 flex justify-center">
                                                <div className="absolute inset-0 h-1/2 bg-gradient-to-r from-blue-600 to-indigo-600"></div>
                                                <div className="relative">
                        ...
                        <div id="administrative-and-technical-staff" className="px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto py-12 bg-white">
                            <h2 className="text-3xl md:text-4xl font-bold text-center mb-10 text-gray-800">
                                <span className="bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">Administrative and Technical Staff</span>
                            </h2>
                            <div className="max-w-6xl mx-auto">
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 justify-items-center">
                                    {(Array.isArray(department?.admin_staff) ? department.admin_staff : []).map((staff, i) => (
                                        <div key={i} className="admin-staff-card bg-white rounded-xl shadow border border-blue-50 overflow-hidden w-64 mb-6">
                                            <div className="relative pt-2 flex justify-center">
                                                <div className="absolute inset-0 h-1/2 bg-gradient-to-r from-blue-600 to-indigo-600"></div>
                                                <div className="relative">
                                            ...
                                            <div className="p-4 text-center">
                                                <h4 className="text-base font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600 mb-1">{staff.name}</h4>
                            ...
                            <div className="p-6 relative">
                                ...
                                <div className="flex flex-col md:flex-row gap-8">
                                    <div className="md:w-1/3 flex flex-col items-center">
                                        <img src={`/${selectedStaff.image}`} alt={selectedStaff.name} className="w-48 h-60 rounded-xl object-cover border-4 border-indigo-100 shadow-md mb-4" />
                                        <h2 className="text-xl font-bold text-gray-800">{selectedStaff.name}</h2>
                                        <p className="text-indigo-600 font-medium">{selectedStaff.position}</p>
                                    ...
                                    <div className="md:w-2/3 max-h-[60vh] overflow-y-auto pr-4 scrollbar-thin text-left space-y-6">
                                        ...
                                        {selectedStaff.professional_experience?.length > 0 && (
                                            <div>
                                                ...
                                                <ul className="space-y-2">{selectedStaff.professional_experience.map((exp, i) => <li key={i} className="bg-gray-50 p-3 rounded-lg"><div className="font-medium">{exp.position}</div><div>{exp.institution}</div><div className="text-xs text-indigo-500">{exp.duration}</div></li>)}</ul>
                                            </div>
                                        )}
                                        {/* Achievements */}
