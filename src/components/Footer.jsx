...
const Footer = () => {
    return (
        <footer className="bg-gradient-to-br from-blue-900 to-indigo-900 text-white border-t border-indigo-700/50">
            {/* Main Footer Content */}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-16">
                    ...
                    <div className="space-y-8">
                        <div>
                            ...
                            <div className="space-y-4 text-indigo-100/80 leading-relaxed text-sm sm:text-base">
                        ...
                        <div className="relative group overflow-hidden rounded-3xl shadow-2xl border border-white/10 transform transition-all hover:scale-[1.02]">
                            <div className="absolute inset-0 bg-indigo-900/10 pointer-events-none group-hover:bg-indigo-900/0 transition-all"></div>
                            <iframe
                        ...
                        <div className="grid grid-cols-1 gap-4">
                            {[
                                ...
                                <Link key={idx} to={link.to} className="group flex items-center gap-4 py-3 px-5 rounded-2xl hover:bg-white/5 transition-all">
                                    <div className="w-8 h-8 rounded-full bg-indigo-500/20 flex items-center justify-center group-hover:bg-yellow-400 group-hover:text-indigo-900 transition-all">
                                        <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path d={link.icon}></path></svg>
                                    </div>
                                    <span className="text-indigo-100 font-bold group-hover:text-white transition-colors">{link.label}</span>
                                </Link>
                            ))}
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="space-y-3">
                            {[
                                ...
                                <Link key={idx} to={res.to} className="block py-4 px-6 bg-white/5 hover:bg-white/10 border border-white/5 rounded-2xl text-indigo-100 font-bold hover:text-white transition-all hover:translate-x-1">
                                    {res.label}
                                </Link>
                            ))}
                        </div>
                    ...
                    <div className="space-y-8">
                        <div>
                            ...
                            <div className="flex flex-wrap gap-4">
                                {[
                                    ...
                                    <a key={idx} href="#" className="w-14 h-14 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center hover:bg-yellow-400 hover:text-indigo-900 transition-all transform hover:rotate-12">
                        ...
                        <div className="p-6 bg-white/5 rounded-[2.5rem] border border-white/10 space-y-2">
                            ...
                            <p className="text-sm text-indigo-100/70 font-medium leading-relaxed">Anna University Coimbatore is committed to providing quality education in a safe campus environment.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            {/* Footer Bottom Bar */}
            <div className="bg-indigo-950/80 backdrop-blur-md border-t border-indigo-800/50">
                <div className="container mx-auto px-4 sm:px-6 py-8">
                    <div className="flex flex-col md:flex-row justify-between items-center gap-6">
                        ...
                        <div className="flex items-center gap-8">
                            <a href="#" className="text-indigo-200/60 hover:text-yellow-400 text-xs font-black uppercase tracking-widest transition-colors">Team</a>
                            <a href="#" className="text-indigo-200/60 hover:text-yellow-400 text-xs font-black uppercase tracking-widest transition-colors">Privacy</a>
                            <a href="#" className="text-indigo-200/60 hover:text-yellow-400 text-xs font-black uppercase tracking-widest transition-colors">Safety</a>
                        </div>
                    </div>
                </div>
            </div>
